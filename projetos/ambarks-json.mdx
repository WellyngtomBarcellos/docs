...
| Campo | Uso |
| --- | --- |
| `build.installCommand` | Comando para instalar dependências |
| `build.install` | Atalho alternativo para comando de instalação |
| `build.buildCommand` | Comando para gerar build |
| `build.command` | Atalho alternativo para comando de build |
| `run.command` | Comando usado para iniciar a aplicação |

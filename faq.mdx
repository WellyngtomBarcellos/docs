...
Use `ambarks.json` quando o comando padrão não servir. Ele é ideal para definir instalação, build e start de forma explícita.
...
## Preciso reenviar deploy depois de mudar variáveis?
